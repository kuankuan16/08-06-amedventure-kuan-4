...
/* One slide per idea from AMED's brief: the ecosystem approach, the cross-border footprint,
   and partnership beyond capital. Copy is the firm's own wording, and the three statements are
   written in the firm's own voice — each opens with "We" and names the people rather than the
   mechanics. Lines are broken by hand rather than left to wrap, so every headline is exactly
   two lines at any viewport width and the frame below never shifts. */
const heroSlides: HeroSlide[] = [
  {
    src: "/images/amed/hero-b-01.jpg",
    alt: "Two colleagues talking beside a bench of catheter and implant samples",
    headline: <><span><span>We help <em>founders</em> carry a device</span></span><span><span>from the first sketch to the bedside.</span></span></>,
  },
  {
    src: "/images/amed/hero-b-02.jpg",
    alt: "An investor listening as a founder talks through drawings side by side",
    headline: <><span><span>We stay with <em>the builders</em> of medicine</span></span><span><span>long after the first check clears.</span></span></>,
  },
  {
    src: "/images/amed/hero-b-03.jpg",
    alt: "A cross-border team mid-discussion over printouts and a device",
    headline: <><span><span>We back <em>the teams</em> changing what good</span></span><span><span>care looks like on two continents.</span></span></>,
  },
];
  ...
  return (
    <div className={styles.page} ref={pageRef} onClick={jumpToSection}>
      ...
      <header className={`${styles.header} ${scrolled ? styles.headerScrolled : ""}`} ref={headerRef}>
        ...
        <Link className={styles.brand} href="/b" aria-label="AMED Ventures home" onClick={scrollToTop}>
