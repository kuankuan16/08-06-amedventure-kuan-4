  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400&amp;family=Mulish:wght@300;400;500&amp;family=Lora:wght@400;500&amp;display=swap" />
      </head>
      <body>{children}</body>
    </html>
  );
